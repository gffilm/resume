...
const Zen = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setTimeout(() => setStartSpeaking(true), 4000)
      setTimeout(() => setPlayAmbient(true), 4000)
  ...
  return (
    <section className="fade-background">
      ...
      >
        ...
        {playSoundFX && <AudioPlayerWithVolume title="sound fx" volume={30} videoId='X0NgSuFY2bk' />}
        {startSpeaking && <TextToSpeech text='Welcome to the Zen experience.' />}
      </Box>
    </section>
  )
}
